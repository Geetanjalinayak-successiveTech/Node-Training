...
2. Create an index on customerName. Run a query filtering by customerName and
check performance using explain("executionStats").


![Orders Aggregation Example](./images/Indexing1.1.png)
![Orders Aggregation Example](./images/Indexing1.2.png)
![Orders Aggregation Example](./images/Indexing1.3.png)




3. Create a compound index on status and orderDate. Run a query filtering by both
and compare performance (before vs after).


![Orders Aggregation Example](./images/Indexing2.1.png)
![Orders Aggregation Example](./images/Indexing2.2.png)
...
![Orders Aggregation Example](./images/Indexing4.1.png)
![Orders Aggregation Example](./images/Indexing4.2.png)
...
![Orders Aggregation Example](./images/Indexing5.png)
